          ...
          <tr key={item.key}>
            ...
            <td className="py-1.5 pr-1.5 border-b border-paper-line">
              <select
                ...
                className={`rating-select w-20 px-2 py-1 text-xs font-semibold border rounded border-paper-line cursor-pointer bg-white ${data?.[item.key] ? 'rating-' + data[item.key] : ''}`}>
                <option value="">—</option>
